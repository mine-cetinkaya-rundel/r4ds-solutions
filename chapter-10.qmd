...
2. Type ?geom_col tells you in the description,geom_bar makes the height of the bar proportional to the number of cases in each group while geom_col,"If you want the heights of the bars to represent values in the data, use `geom_col()`".

3. Alot of the geoms use stat = identity and some use bin and count.
