...
4.  The advantages of faceting is seeing each subgroup apart from each other to see more clearly.
    the disadvantages are not seeing the data overlap with each other.im pretty sure they'll just be more points.
...
2.  Type ?g
    eom_col tells you in the description,geom_bar makes the height of the bar proportional to the number of cases in each group while geom_col,"If you want the heights of the bars to represent values in the data, use `geom_col()`".
